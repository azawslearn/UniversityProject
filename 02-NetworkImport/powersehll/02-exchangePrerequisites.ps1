...
$prereq_files = @(
    ...
    @{ name = "Exchange 2016 CU23 ISO"; url = "https://download.microsoft.com/download/8/d/2/8d2d01b4-5bbb-4726-87da-0e331bc2b76f/ExchangeServer2016-x64-CU23.ISO"; dest = "Exchange2016-CU23.iso" }
)
